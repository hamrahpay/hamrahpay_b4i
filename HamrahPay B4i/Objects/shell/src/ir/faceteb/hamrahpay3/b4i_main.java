...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("ir.faceteb.hamrahpay3.b4i_main");
        //anywheresoftware.b4a.pc.RapidSub.moduleToObject.put("ir.faceteb.hamrahpay3.b4i_main", "ir.faceteb.hamrahpay3.b4i_main");
	}
...
public static b4i_mainpage _mainpage = null;
  public Object[] GetGlobals() {
		return new Object[] {"App",b4i_main._app,"HamrahPay",Debug.moduleToString(b4i_hamrahpay.class),"HttpUtils2Service",Debug.moduleToString(b4i_httputils2service.class),"mainpage",Debug.moduleToString(b4i_mainpage.class),"NavControl",b4i_main._navcontrol,"Payment_page",Debug.moduleToString(b4i_payment_page.class)};
}
}