...
try {
		Debug.PushSubsStack("Complete (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,69);
...
try {
		Debug.PushSubsStack("Download (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,39);
...
try {
		Debug.PushSubsStack("Download2 (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,48);
...
try {
		Debug.PushSubsStack("GetBitmap (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,90);
...
try {
		Debug.PushSubsStack("GetInputStream (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,96);
...
try {
		Debug.PushSubsStack("GetRequest (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,64);
...
try {
		Debug.PushSubsStack("GetString (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,80);
...
try {
		Debug.PushSubsStack("GetString2 (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,85);
...
try {
		Debug.PushSubsStack("Initialize (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,17);
...
try {
		Debug.PushSubsStack("PostBytes (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,27);
...
try {
		Debug.PushSubsStack("PostFile (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,33);
...
try {
		Debug.PushSubsStack("PostString (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,22);
...
try {
		Debug.PushSubsStack("Release (httpjob) ","httpjob",3,__ref.getField(false, "bi"),__ref,75);
