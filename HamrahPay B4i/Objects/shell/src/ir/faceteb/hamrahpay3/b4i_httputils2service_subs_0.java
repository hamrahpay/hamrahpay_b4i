...
try {
		Debug.PushSubsStack("CompleteJob (httputils2service) ","httputils2service",4,b4i_httputils2service.ba,b4i_httputils2service.mostCurrent,33);
...
Debug.ShouldStop(2);
_job = RemoteObject.createNew("b4i_httpjob");Debug.locals.put("job", _job);
 BA.debugLineNum = 35;BA.debugLine="job = TaskIdToJob.Get(TaskId)";
Debug.ShouldStop(4);
_job = (b4i_httputils2service._taskidtojob.runMethod(false,"Get:",(Object)((_taskid))));Debug.locals.put("job", _job);
...
try {
		Debug.PushSubsStack("hc_ResponseError (httputils2service) ","httputils2service",4,b4i_httputils2service.ba,b4i_httputils2service.mostCurrent,24);
...
try {
		Debug.PushSubsStack("hc_ResponseSuccess (httputils2service) ","httputils2service",4,b4i_httputils2service.ba,b4i_httputils2service.mostCurrent,29);
...
try {
		Debug.PushSubsStack("initialize (httputils2service) ","httputils2service",4,b4i_httputils2service.ba,b4i_httputils2service.mostCurrent,9);
...
try {
		Debug.PushSubsStack("SubmitJob (httputils2service) ","httputils2service",4,b4i_httputils2service.ba,b4i_httputils2service.mostCurrent,13);
